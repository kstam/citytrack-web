...
describe('AreaBox', function() {
    ...
    describe('constructor', function() {
        ...
        it('should not allow invocation without the new keyword', function() {
            expect(function() {
                AreaBox(name, boundingBox, Area.STATIC_TYPE);
            }).to.throw(TypeError);
        });

        it('should accept name and bounding box arguments', function() {
            var area = new AreaBox(name, boundingBox, Area.INTERACTIVE_TYPE);
        ...
        it('should not accept null bounding box', function() {
            expect(function() {
                new AreaBox(name, null);
            }).to.throw(Error);
        });

        it('should not accept an invalid type', function() {
            expect(function() {
                new AreaBox(name, boundingBox, 'wrong')
            }).to.throw(Error);
        });
    });
    ...
    describe('equals', function() {
        it('should return true if two areas are the same', function() {
            var area1 = testUtils.createRandomBoxArea('Athens');
            var area2 = area1;
        ...
        it('should return false otherwise', function() {
            var area1 = testUtils.createRandomBoxArea('Athens');
            var area2 = testUtils.createRandomBoxArea('Zurich');
